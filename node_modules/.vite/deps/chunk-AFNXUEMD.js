...
function createResource(pSource, pFetcher, pOptions) {
  ...
  function load(refetching = true) {
    ...
    if ("v" in p) {
      if (p.s === 1)
        loadEnd(pr, p.v, void 0, lookup);
      else
        loadEnd(pr, void 0, castError(p.v), lookup);
      return p;
    }
    scheduled = true;
...
function Switch(props) {
  ...
  return createMemo(() => {
    ...
    return fn ? untrack(() => child(mp.keyed ? conditionValue() : () => {
      var _a;
      if (((_a = untrack(switchFunc)()) == null ? void 0 : _a[0]) !== index)
...
//# sourceMappingURL=chunk-AFNXUEMD.js.map
